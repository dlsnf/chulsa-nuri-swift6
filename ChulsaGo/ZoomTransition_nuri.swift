...
//            toViewController?.view.addGestureRecognizer(panGesture)
        ...
        UIView.animate(withDuration: duration, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0, options: UIView.AnimationOptions.curveLinear, animations: { () -> Void in
    ...
    func handlePinchGesture(_ gesture: UIPinchGestureRecognizer){
        ...
        case .ended, .cancelled:
            ...
            let cancelAnimation = (self.shouldCompleteTransition == false && gesture.velocity >= 0) || gesture.state == UIGestureRecognizer.State.cancelled
...
//            print("velocity normal \(normalizedVelocity)")
            ...
            UIView.animate(withDuration: duration, delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: normalizedVelocity, options: UIView.AnimationOptions(), animations: { () -> Void in
